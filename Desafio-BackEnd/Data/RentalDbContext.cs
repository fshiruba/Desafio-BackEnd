...
namespace Desafio_Backend.Data
{
    public class RentalDbContext(DbContextOptions<RentalDbContext> options) : DbContext(options) //, IConfiguration configuration
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Motorbike { AdminId = "SYSTEM", Model = "YAMAHA", ProductionYear = 2000, Plate = "ABC-1234", },
            new Motorbike { AdminId = "SYSTEM", Model = "HONDA", ProductionYear = 2010, Plate = "DEF-5678", });
        }
    }
}